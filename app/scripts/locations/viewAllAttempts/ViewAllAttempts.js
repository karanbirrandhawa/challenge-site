...
var ViewAllAttempts = React.createClass({
	childContextTypes: {
	...
	render: function() {
		var viewAllAttemptsData = {
			viewAllAttemptsTitle: "Challenger Name"
		}
		var self = this;
		return (<div className="main-container">
					<Card>
		    			<CardTitle
							title={viewAllAttemptsData.viewAllAttemptsTitle}
							subtitle="Attempts:" />
							<CardText>
									...
									<List className={testCommits}>
										{
											testCommits.map(function(commitObj, index) {
												return <ListItem
													...
													primaryText={commitObj.commit.message}
													secondaryText={
														<p className="font-normal">
															{commitObj.commit.committer.date}
														</p>			
													}>
													{commitObj.commit.committer.name}
												</ListItem>
											})
										}
									</List>
...
module.exports = ViewAllAttempts;